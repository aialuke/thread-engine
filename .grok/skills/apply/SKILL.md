...
3. Edit only that file, under `.grok/skills/` or `voice/`. Keep the change to what the review proposed. Never touch `APPROVED`, the gate script, `AGENTS.md`, or the truth budget.
