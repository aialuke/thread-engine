...
- **Contract:** `.grok/skills/hidden-settings/SKILL.md` (hook beats, cards, closer, emoji budget) and `.grok/skills/hidden-settings/examples.md`.
...
- **Checklist:** copy `.grok/skills/format-settings/checklist.md` to the draft as `CHECKLIST.md`.
